...
"""
    ...
    for i in lists:
        ...
        if os.path.isdir(f"{path}/{i}"):
            htmlstring += f'\n          <li><a href="{i}/"><img src="/File-icons/folder.svg" width=20px style="width=20px;vertical-align:middle;">  {i}/</a></li>'
        else:
            if ".deb" == os.path.splitext(i)[1]:
                htmlstring += f'\n          <li><a href="{i}"><img src="/File-icons/deb.svg" width=20px style="width=20px;vertical-align:middle;">  {i}</a></li>'
            elif ".jpg" == os.path.splitext(i)[1]:
                htmlstring += f'\n          <li><a href="{i}"><img src="/File-icons/image-jpeg.svg" width=20px style="width=20px;vertical-align:middle;">  {i}</a></li>'
            else:
                htmlstring += f'\n          <li><a href="{i}"><img src="/File-icons/text-x-source.svg" width=20px style="width=20px;vertical-align:middle;">  {i}</a></li>'
    htmlstring += f"""     </ul>
        <hr/>
...
<script>
    window.onload = function(){{
        var d = new Date();
        document.getElementById("copyright").innerHTML = "©2023~" + d.getFullYear() + " gfdgd xi";
    }}
</script>
<script>
var _hmt = _hmt || [];
